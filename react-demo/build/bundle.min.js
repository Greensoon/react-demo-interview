...
/***/ function(module, exports, __webpack_require__) {
	...
	var Data = __webpack_require__(168);

	ReactDOM.render(React.createElement(Main, { datas: Data }), document.getElementById("container"));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Main = React.createClass({
	    ...
	    handleChecked: function handleChecked(parentRef, selectFlag) {
	        this.setState({
	    ...
	    render: function render() {
	        ...
	        return React.createElement(
	            "div",
	            { id: "dmContainer" },
	            React.createElement(Header, { handleChecked: this.handleChecked }),
	            React.createElement(List, { users: users, handleChecked: this.handleChecked })
	        );
	    }
	});
	...
	var Header = React.createClass({
	    ...
	    render: function render() {
	        return React.createElement(
	            ...
	            React.createElement(
	                "button",
	                { id: "dmClearAll", onClick: this.clearChecked },
	                "清空"
	            )
	        );
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ItemTitle = __webpack_require__(167);

	var List = React.createClass({
	    displayName: "List",

	    handleChecked: function handleChecked(parentRef, isAllChecked) {
	        this.props.handleChecked(parentRef, isAllChecked);
	    },
	    render: function render() {
	        var ItemList = [];
	        var lastDept = null;
	        ...
	        var parentRef = this.state.currParent;
	        ...
	        this.props.users.forEach(function (user) {
	            ...
	            if (lastDept != user.dept) {
	                ...
	                ItemList.push(React.createElement(ItemTitle, { name: user.dept, key: user.dept, totalCount: totalCount, handleChecked: handleChecked }));
	            }
	            ...
	            ItemList.push(React.createElement(Item, { user: user, key: user.name, checkFlag: flag }));
	...
	var Item = React.createClass({
	    ...
	    render: function render() {
	        return React.createElement(
	            "li",
	            null,
	            React.createElement("input", { type: "checkbox", checked: this.props.checkFlag }),
	            React.createElement(
	                "span",
	                null,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ItemTitle = React.createClass({
	    ...
	    render: function render() {
	        ...
	        return React.createElement(
	            "li",
	            { className: "dmDeptTitle" },
	            React.createElement("input", { type: "checkbox", onClick: this.handleCheckbox, checked: this.props.checked }),
	            React.createElement(
	                "span",
	                null,
	                this.props.name
...
/***/ function(module, exports) {
	...
	module.exports = [{ dept: "工程研发部门", name: "Mac 开发工程师", count: "9" }, { dept: "工程研发部门", name: "IOS App测试工程师", count: "17" }, { dept: "工程研发部门", name: "Android远程控制工程师", count: "61" }, { dept: "工程研发部门", name: "Web 前端工程师", count: "31" }, { dept: "工程研发部门", name: "Android 多媒体软件开发工程师", count: "2" }, { dept: "产品设计部门", name: "网页设计师", count: "47" }, { dept: "产品设计部门", name: "ID /工业设计师", count: "39" }, { dept: "产品设计部门", name: "视觉设计师/GUI界面设计师", count: "42" }, { dept: "产品设计部门", name: "平面设计师", count: "8" }];
