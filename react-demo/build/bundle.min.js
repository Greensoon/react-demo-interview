	...
	var Main = React.createClass({
	    ...
	    render: function render() {
	        ...
	        return React.createElement(
	            ...
	            React.createElement(List, { users: users })
	        );
	    }
	});
	    ...
	    render: function render() {
	        ...
	        this.props.users.forEach(function (user) {
	            if (lastDept != user.dept) {
	                ItemList.push(React.createElement(ItemTitle, { name: user.dept, key: user.dept, totalCount: totalCount }));
	                totalCount = 0;
	            }
	            ItemList.push(React.createElement(Item, { user: user, key: user.name }));
